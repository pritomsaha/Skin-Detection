...
class TrainingSetGenerator {
	...
	public static final String directoryPath = "/home/nazmul/Desktop/ibtd";
	public static final String trainSetPath = "trainingSet.txt";
	...
	void readData() throws IOException{
		...
		out = new PrintStream(new File(trainSetPath));
		
		Files.walk(Paths.get(directoryPath)).forEach(filePath -> {
			if (Files.isRegularFile(filePath)) {
				String[] tokens = filePath.toString().split("/");
				tokens = tokens[5].split(".jpg");
				String maskPath =  directoryPath+"/Mask/" + tokens[0] + ".bmp";
	...
	static public void main(String args[]) throws Exception 
	{
		...
		new TrainingSetGenerator().readData();
